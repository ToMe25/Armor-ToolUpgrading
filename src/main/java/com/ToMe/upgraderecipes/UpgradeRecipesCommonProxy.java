...
public class UpgradeRecipesCommonProxy {
		...
		if(Config.lapisDust || Config.dummyItems) {
			...
			UpgradeRecipesTab = new CreativeTabs("upgraderecipes") {
				...
				public ItemStack getTabIconItem() {
					...
					return new ItemStack(dummyItems.isEmpty() ? LapisDust : dummyItems.get(0));
				}
			};
		}
	...
	protected static void initItemMaterialMap() {
		...
		ItemMap.put("tritanium:hoe", new ResourceLocation("matteroverdrive:tritanium_hoe"));
		ItemMap.put("tritanium:sword", new ResourceLocation("matteroverdrive:tritanium_sword"));
		ItemMap.put("tritanium:helmet", new ResourceLocation("matteroverdrive:tritanium_helmet"));
		ItemMap.put("tritanium:chestplate", new ResourceLocation("matteroverdrive:tritanium_chestplate"));
		ItemMap.put("tritanium:leggings", new ResourceLocation("matteroverdrive:tritanium_leggings"));
		ItemMap.put("tritanium:boots", new ResourceLocation("matteroverdrive:tritanium_boots"));
